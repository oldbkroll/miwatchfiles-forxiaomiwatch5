...
当前 M0、M1 和 M2 已完成，项目仍处于 Debug 开发阶段。
...
- 当前 Debug 版本：`0.3.1-dev-debug`，`versionCode=6`

## 构建

使用 Android Studio 打开项目根目录，选择 `debug` 构建变体。也可以在项目根目录执行：
