...
`TextTransactionJournal.kt` 的既有 warning。当前最终 Debug APK 为 `0.3.1-dev-debug`、versionCode 6、targetSdk 29，
SHA-256 为 `E4930E8175AF76E947DCECE9686B67FBD57E80DC2F3D3DBD4C7695884D46023A`。
...
该设备验收使用的是 Task 6 安装构建 `379DB662A806FABC190DD45A0C933863F84A09F98BA21BF9B93AABB946F3A22E`；之后的
断开重绑修复 `1ccc780` 已通过单元测试和当前 Debug gate，但尚未重新安装到设备复测。
